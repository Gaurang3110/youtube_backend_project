...
const addVideoToPlaylist = asyncHandler(async (req, res) => {
  ...
  if (
    ...
    throw new ApiError(
      400,
      "You are not allowed to add videos to this playlist"
    );
  }
  ...
  if (!updatedPlaylist) {
    throw new ApiError(
      500,
      "An error occured while adding the video to the playlist"
    );
  }
...
const removeVideoFromPlaylist = asyncHandler(async (req, res) => {
  ...
  if (
    ...
    throw new ApiError(
      400,
      "You are not allowed to remove a video from this playlist"
    );
  }
  ...
  if (!updatedPlaylist) {
    throw new ApiError(
      404,
      "An error occured while removing the video from the playlist"
    );
  }
...
const updatePlaylist = asyncHandler(async (req, res) => {
  ...
  if (!updatedPlaylist) {
    throw new ApiError(404, "An Errpr occured while updating the playlist");
  }
  return res
    .status(200)
    .json(
